...
public class Wait extends MavlinkAction {

	private long duration_in_ms;
	private long timer_in_ms;


	public Wait(MavlinkConnection connection, MavlinkCommunicationModel droneModel, float duration_in_sec) {
		super(MavlinkActionType.WAIT, connection, droneModel);
