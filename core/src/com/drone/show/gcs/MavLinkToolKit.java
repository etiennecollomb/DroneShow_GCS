...
public class MavLinkToolKit {
	...
	// Copter Mission use MAV_CMD_DO_SET_HOME command to set the ìhome positionî in the global coordinate frame (MAV_FRAME_GLOBAL)
	...
	/** Message Interval
	 * Permet de demander l'envoie d'un message depuis le pixhawk pour avoir des donn√©es de telemetry
